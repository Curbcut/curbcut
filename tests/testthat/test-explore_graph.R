...
test_explores <- function(var_right, select_id, df) {
  # Pct
  test_explore_graph_helper("housing_tenant_2021", var_right = var_right, df = df,
                       select_id = select_id)

  # Dollar
  test_explore_graph_helper("housing_rent_2021", var_right = var_right, df = df,
                       select_id = select_id)
  ...
  # Ind scalar
  test_explore_graph_helper("canale_2021", var_right = var_right, df = df,
                       select_id = select_id)

  # sqkm
  test_explore_graph_helper("alley_sqkm_2023", var_right = var_right, df = df,
                       select_id = select_id)

  # per1k
  test_explore_graph_helper("alley_per1k_2023", var_right = var_right, df = df,
                       select_id = select_id)
}
...
test_explores_delta <- function(var_right, select_id, df) {
  # Pct
  test_explore_graph_helper(paste0("housing_tenant_", c(2016, 2021)), var_right = var_right,
                       df = df, select_id = select_id)

  # Dollar
  test_explore_graph_helper(paste0("housing_rent_", c(2016, 2021)), var_right = var_right,
                       df = df, select_id = select_id)
  ...
  # Ind scalar
  test_explore_graph_helper(paste0("canale_", c(2016, 2021)), var_right = var_right, df = df,
                       select_id = select_id)
}
...
test_explores_delta <- function(var_right, select_id, df) {
  ...
  # Ind scalar
  test_explore_graph_helper(paste0("canale_", c(2016, 2021)), var_right = var_right,
                       df = df, select_id = select_id)
}
