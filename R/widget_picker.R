...
picker_server <- function(id, r, picker_id = "var", var_list,
  ...
  shiny::moduleServer(id, function(input, output, session) {
    ...
    hovers <- shiny::reactive(picker_hover_divs(var_list = var_list_t(),
                                                lang = r$lang()))
    ...
    disable <- shiny::reactive(picker_multi_year_disable(var_list = var_list,
                                                         disable = multi_year()))
    ...
    # Append the `time`
    var <- shiny::reactive(picker_return_var(input = input[[picker_id]],
                                             time = time()))
