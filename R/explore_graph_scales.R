...
#' "dollar" method.
#' @export
explore_graph_scale.ind <- function(var, x_y, scale, data_vals, lang = NULL, ...) {
  explore_graph_scale_ind(
    var = var, x_y = x_y, scale = scale,
...
#' method.
explore_graph_scale_ind <- function(var, x_y, scale, lang = NULL, ...) {
...
#' @export
explore_graph_scale_ind.scalar <- function(var, x_y, scale, lang = NULL, data_vals, ...) {
...
#' @export
explore_graph_scale_ind.ordinal <- function(var, x_y, scale, lang = NULL, data, ...) {
