  ...
  default_elements <-
    data.frame(
      ...
      intro = c(cc_t("Curbcut is designed as a series of pages that explore ",
                     "a given theme. Here you’ll find information about the ",
                ...
                cc_t("This function allows you to select a variable to compare ",
                     "with the one selected on the left-hand panel. We’ll show ",
                     "you the potential relationship between the variables of ",
                     "your choice.", lang = lang),
                cc_t("You’ll see meaningful information here about the variables ",
                ...
                cc_t("Congratulations on completing the tutorial! If you'd like ",
