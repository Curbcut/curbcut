...
contents <- lapply(all_themes, \(t) {
  ...
  cards <- lapply(vars, \(var) {
    ...
    var_title <- curbcut::cc_t(params$variables$var_title[params$variables$var_code == var], lang = "fr")
    ...
    if (!is.na(parent_string) & parent_string %in% params$variables$var_code) {
    ...
    list(box = bslib::value_box(
      ...
      value = paste0(ordinal_form(percentile), " percentile") |>  curbcut::s_sentence(),
      showcase = myImage,
